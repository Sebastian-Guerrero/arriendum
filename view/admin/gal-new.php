...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR GALERIA INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="gal-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR GALERIA INMUEBLE</a>
					</li>
					<li>
						<a href="gal-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA GALERIA INMUEBLE</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="" name="agregarGaleria"  class="form-neon" autocomplete="off" method="POST" enctype="multipart/form-data">
					<fieldset>
						<legend class="text-center"><i class="fas fa-images"></i> &nbsp; Registrar Galeria Inmueble</legend>
