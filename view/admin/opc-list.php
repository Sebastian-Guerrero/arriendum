						...
						<tbody>
							...
							<tr class="text-center" >
								...
								<a  class="btn btn-success" href="<?php 
										if($arreglo2[0]<>''){
											echo "opc-update.php?key=".urlencode($arreglo2[0]) ;
										}
																		?>" >
								...
								<td>
									<form action="" name="eliminarOpcion" method="POST">
										<input type="hidden" name="id_option_property" value="<?php echo $arreglo2[0] ?>"></input>
										<input type="hidden" name="name_option_property"></input>
