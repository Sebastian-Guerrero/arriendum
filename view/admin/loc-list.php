...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from location_property where id_location_property like '%$obj->id_location_property%' limit $desde,$maximoRegistros";
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA LOCALIDAD INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA LOCALIDAD INMUEBLE</a>
					</li>
					<li>
						<a href="loc-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR LOCALIDAD INMUEBLE</a>
					</li>
					...
					<table class="table table-dark table-sm">
						<thead>
							<tr class="text-center roboto-medium">
								<th>ID LOCALIDAD INMUEBLE</th>
								<th>LOCALIDAD INMUEBLE</th>
								<th>ACTUALIZAR</th>
								<th>ELIMINAR</th>
							</tr>
						</thead>
							...
							<tr class="text-center" >
								...
								<td>
									<a  class="btn btn-success" href="<?php 
										if($arreglo2[0]<>''){
											echo "loc-update.php?key=".urlencode($arreglo2[0]) ;
										}
																		?>" >
								...
								<td>
									<form action="" name="eliminarLocalidad" method="POST">
										<input type="hidden" name="id_location_property" value="<?php echo $arreglo2[0] ?>"></input>
										<input type="hidden" name="name_location_property"></input>
