...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from type_property where nombreTipo like '%$obj->nombreTipo%' limit $desde,$maximoRegistros";
...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA TIPO INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA TIPO INMUEBLE</a>
					</li>
					<li>
						<a href="tipo-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR TIPO INMUEBLE</a>
					</li>
