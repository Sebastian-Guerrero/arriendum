...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR LOCALIDAD INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR LOCALIDAD INMUEBLE</a>
					</li>
					<li>
						<a href="loc-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA LOCALIDAD INMUEBLE</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="" name="agregarLocalidad"  class="form-neon" autocomplete="off" method="POST">
					<fieldset>
						<legend class="text-center"><i class="fas fa-layer-group"></i> &nbsp; Registrar Localidad Inmueble</legend>

						<div class="container-fluid">
							<div class="row">
							<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">CODIGO DE LOCALIDAD INMUEBLE</label>
										<input type="number" class="form-control" name="idLocalidad" id="idLocalidad" required>
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">NOMBRE PARA LOCALIDAD INMUEBLE</label>
										<input type="text" class="form-control" name="nombreLocalidad" id="nombreLocalidad" required>
									</div>
								</div>
