					...
					<fieldset>
						...
						<div class="container-fluid">
							<div class="row">
								...
								<input type="hidden" name="id_location_property" id="id_location_property">

								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">NOMBRE PARA LOCALIDAD INMUEBLE</label>
										<input type="text" class="form-control" name="name_location_property" id="name_location_property" required>
									</div>
								</div>
