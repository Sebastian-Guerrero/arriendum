...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from galery_property where id_property like '%$obj->id_property%' limit $desde,$maximoRegistros";
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR GALERIA INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="gal-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR GALERIA INMUEBLE</a>
					</li>
				</ul>	
			</div>
...
<form action="" name="galeria" method="POST" autocomplete="off">
			<!-- Content here-->
			<div class="container-fluid">
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">INGRESA CODIGO DEL INMUEBLE:</label>
									<input class="form-control me-2" type="search" name="id_property" aria-label="Search">
								</div>
							</div>
							<div class="col-12">
					...
					<table class="table table-dark table-sm">
						<thead>
							<tr class="text-center roboto-medium">
								<th>ID GALERIA INMUEBLE</th>
								<th>ID INMUEBLE</th>
                                <th>GALERIA INMUEBLE</th>
							</tr>
						</thead>
						<tbody>
							<tr>
