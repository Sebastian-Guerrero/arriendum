...
include("../../controller/admin/locationController.php");
...
$query="SELECT * FROM location_property WHERE id_location_property = '$key'";
$resultado = mysqli_query($c, $query);
$arreglo = mysqli_fetch_array($resultado); 

$obj->id_location_property = $arreglo[0];
$obj->name_location_property = $arreglo[1];
...
<head>
	...
	<title>Localidad Inmueble</title>
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR LOCALIDAD INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<form class="form-neon" action="" method="POST" autocomplete="off">
					<fieldset>
						<legend class="text-center"><i class="fas fa-layer-group"></i> &nbsp; Actualizar Localidad Inmueble</legend>
						...
						<div class="container-fluid">
							...
							<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">ID LOCALIDAD INMUEBLE:</label>
										<input type="number" readonly class="form-control" name="id_location_property" id="id_location_property" value ="<?php echo $obj->id_location_property ?>">
									</div>
								</div>

								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">NUEVO NOMBRE PARA LOCALIDAD INMUEBLE:</label>
										<input type="text" class="form-control" name="name_location_property" id="name_location_property" value ="<?php echo $obj->name_location_property ?>" required>
									</div>
								</div>
