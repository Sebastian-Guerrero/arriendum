...
<section class="full-box page-content">
			...
			<div class="container-fluid">
				<form class="form-neon" action="" method="POST" autocomplete="off">
					<fieldset>
						<legend class="text-center"><i class="fas fa-layer-group"></i> &nbsp; Ingresa el Codigo de Localidad Inmueble</legend>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">CODIGO DEL LOCALIDAD INMUEBLE</label>
										<input type="number" class="form-control" name="idLocalidad" id="idLocalidad">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="nombreLocalidad" id="nombreLocalidad">
									</div>
								</div>
