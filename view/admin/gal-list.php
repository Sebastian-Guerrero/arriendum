...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from galery_property where id_galery_property like '%$obj->id_galery_property%' limit $desde,$maximoRegistros";
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA GALERIA INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="#"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA GALERIA INMUEBLE</a>
					</li>
					<li>
						<a href="gal-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR GALERIA INMUEBLE</a>
					</li>
