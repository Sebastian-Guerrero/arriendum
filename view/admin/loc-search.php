		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR LOCALIDAD INMUEBLE 
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="loc-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR LOCALIDAD INMUEBLE</a>
					</li>
				</ul>	
			</div>
...
<form action="" name="localidad" method="POST" autocomplete="off">
			<!-- Content here-->
			<div class="container-fluid">
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">INGRESA CODIGO DE LOCALIDAD INMUEBLE</label>
									<input class="form-control me-2" type="search" name="id_location_property" aria-label="Search">
								</div>
							</div>
							<div class="col-12">
