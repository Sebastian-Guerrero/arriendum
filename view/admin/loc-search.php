...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from localidad_inmueble where nom_localidad_inm like '%$obj->nombreLocalidad%' limit $desde,$maximoRegistros";
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">INGRESA NOMBRE DE LOCALIDAD INMUEBLE</label>
									<input class="form-control me-2" type="search" name="nombreLocalidad" aria-label="Search">
								</div>
							</div>
							<div class="col-12">
