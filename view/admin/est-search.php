...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from state_property where id_state_property like '%$obj->id_state_property%' limit $desde,$maximoRegistros";
...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ESTADO INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="doc-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ESTADO INMUEBLE</a>
					</li>
				</ul>	
			</div>
...
<form action="" name="estado" method="POST">
			<!-- Content here-->
			<div class="container-fluid">
				<form class="form-neon" action="" role="search">
					<div class="container-fluid">
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">INGRESA CODIGO DE ESTADO INMUEBLE:</label>
									<input class="form-control me-2" type="search" name="id_state_property" aria-label="Search">
								</div>
							</div>
							<div class="col-12">
