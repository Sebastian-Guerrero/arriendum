...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ESTADO INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ESTADO INMUEBLE</a>
					</li>
					<li>
						<a href="est-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA ESTADO INMUEBLE</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="" name="agregarEstado"  class="form-neon" autocomplete="off" method="POST">
					<fieldset>
						<legend class="text-center"><i class="fas fa-check"></i> &nbsp; Registrar Estado Inmueble</legend>
