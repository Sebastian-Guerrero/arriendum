		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR ROL USUARIO
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="rol-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ROL USUARIO</a>
					</li>
					<li>
						<a href="rol-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA ROL USUARIO</a>
					</li>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">ID ROL USUARIO:</label>
										<input type="number" readonly class="form-control" name="id_rol_user" id="id_rol_user" value ="<?php echo $obj->id_rol_user ?>">
									</div>
								</div>
