		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR OPCION INMUEBLE
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR OPCION INMUEBLE</a>
					</li>
					<li>
						<a href="opc-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA OPCION INMUEBLE</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="" name="agregarOpcion"  class="form-neon" autocomplete="off" method="POST">
					<fieldset>
						<legend class="text-center"><i class="fas fa-laptop-house"></i> &nbsp; Registrar Opcion Inmueble</legend>

						<div class="container-fluid">
							<div class="row">

								<input type="hidden" name="id_option_property" id="id_option_property" required>

								<div class="col-12 col-md-6">
									<div class="form-group">
										<label class="bmd-label-floating">NOMBRE PARA OPCION INMUEBLE</label>
										<input type="text" class="form-control" name="name_option_property" id="name_option_property" required>
									</div>
								</div>
