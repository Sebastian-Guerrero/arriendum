...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ROL USUARIO
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ROL USUARIO</a>
					</li>
					<li>
						<a href="rol-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA ROL USUARIO</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="" name="agregarRol"  class="form-neon" autocomplete="off" method="POST">
					<fieldset>
						<legend class="text-center"><i class="fas fa-user-tag"></i> &nbsp; Registrar Rol Usuario</legend>
