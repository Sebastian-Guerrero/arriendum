		...
		<div class="preguntas">
			...
			<div class="contenedor-preguntas activo" data-categoria="metodos-pago">
				<div class="contenedor-pregunta">
					<p class="pregunta">1.¿Qué métodos de pago maneja el sistema? <img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
				...
				<div class="contenedor-pregunta">
					<p class="pregunta">2.¿Cómo me contacto con el dueño de inmueble? <img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
			...
			<div class="contenedor-preguntas" data-categoria="entregas">
				<div class="contenedor-pregunta">
					<p class="pregunta">1.¿Como puedo actualizar mi inmueble?<img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
				...
				<div class="contenedor-pregunta">
					<p class="pregunta">2.¿Como puedo publicar un inmueble? <img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
					<p class="respuesta">a la hora de encontrar un inmueble en el aplicativo. se debe dirigir donde dice "mas informacion", hecho esto se desplegara una tarjeta que tendra toda la informacion del inmueble como tipo de inmueble, si esta en venta o en arriendo, una descripcion breve del inmueble y numero de contacto del dueño de la publicacion</p>
				</div>
			</div>
			...
			<div class="contenedor-preguntas" data-categoria="seguridad">
				<div class="contenedor-pregunta">
					<p class="pregunta">1.¿A partir de qué edad los menores pueden ceder sus datos personales? <img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
				...
				<div class="contenedor-pregunta">
					<p class="pregunta">2.¿Porque el sistema necesita recopilar estos datos?<img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
			...
			<div class="contenedor-preguntas" data-categoria="cuenta">
				<div class="contenedor-pregunta">
					<p class="pregunta">1.¿Quién gestiona los usuario? <img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
				...
				<div class="contenedor-pregunta">
					<p class="pregunta">2.¿Cómo puedo actualizar mis datos?<img src="assets/img/suma.svg" alt="Abrir Respuesta" /></p>
