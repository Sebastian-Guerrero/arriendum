...
function Header()
{
    ...
    // Título
    $this->Cell(85,30,'Tabla de usuarios ',0,0,'C');
    // Salto de línea
    ...
    $this->Cell(45,10,'Creacion',1,1,'C',0);
...
while ($row=$resultado2->fetch_assoc()) {
    ...
    $pdf->Cell(20,10,$row['state_user'],1,0,'C',0);
    $pdf->Cell(15,10,$row['rol_user'],1,0,'C',0);
    $pdf->Cell(29,10,$row['type_document'],1,0,'C',0);
	$pdf->Cell(35,10,$row['name_user'],1,0,'C',0);
    $pdf->Cell(35,10,$row['lastname_user'],1,0,'C',0);
    $pdf->Cell(30,10,$row['phone_user'],1,0,'C',0);
    $pdf->Cell(45,10,$row['email_user'],1,0,'C',0);
    $pdf->Cell(45,10,$row['create_user'],1,1,'C',0);
