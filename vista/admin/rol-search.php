...
<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-center">
					<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ROL USUARIO
				</h3>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="rol-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ROL USUARIO</a>
					</li>
				</ul>	
			</div>
...
<form action="" name="rol" method="POST" autocomplete="off">
			<!-- Content here-->
			<div class="container-fluid">
